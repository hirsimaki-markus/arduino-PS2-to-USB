...
void parseNewBuffer(void) {
  ...
  //Serial.print("oldBuffer: "); // DEBUG
  //DEBUG_HEXPRINT(oldBuffer);// DEBUG
  //Serial.print("newBuffer: ");// DEBUG
  //DEBUG_HEXPRINT(newBuffer);// DEBUG
...
aika tavujen välissä on 1200 µs (or 1320?)
=======================================================[ SHORT SET (DATA /// BREAK DATA) (DATA /// 0xF0 DATA) ]=======================================================
0x05 F1     0x70 NUMPAD_0    0x45 0    0x1D Q    0x1B A    0x22 Z    0x4E +           0x0D TAB
0x06 F2     0x69 NUMPAD_1    0x16 1    0x24 W    0x23 S    0x21 X    0x55 ´           0x58 CAPS_LOCK
0x04 F3     0x72 NUMPAD_2    0x1E 2    0x2D E    0x2B D    0x2A C    0x1C ¨           0x12 L_SHIFT
0x0C F4     0x7A NUMPAD_3    0x26 3    0x2C R    0x34 F    0x32 V    0x61 '           0x14 L_CTRL
0x03 F5     0x6B NUMPAD_4    0x25 4    0x35 T    0x33 G    0x31 B    0x1A <           0x11 L_ALT
0x0B F6     0x73 NUMPAD_5    0x2E 5    0x3C Y    0x3B H    0x3A N    0x49 ,           0x66 BACKSPACE
0x83 F7     0x74 NUMPAD_6    0x36 6    0x43 U    0x42 J    0x41 M    0x4A .           0x5A ENTER
0x0A F8     0x6C NUMPAD_7    0x3D 7    0x44 I    0x4B K              0x29 -           0x59 R_SHIFT
0x01 F9     0x75 NUMPAD_8    0x3E 8    0x4D O    0x4C L              0x7C NUMPAD_*    0x7E SCROLL_LOCK
0x09 F10    0x7D NUMPAD_9    0x46 9    0x54 P    0x52 Ö              0x7B NUMPAD_-    0x77 NUM_LOCK
0x78 F11                     0x5B Å    0x5D Ä    0x79 NUMPAD_+
0x07 F12

===========================================[ LONG SET (SPECIAL DATA /// SPECIAL BREAK DATA) (0xE0 DATA /// 0xE0 0xF0 DATA) ]===========================================
0x70 INSERT     0x75 ARROW_UP       0x11 ALT_GR
0x6C HOME       0x74 ARROW_RIGHT    0x14 CTRL_ACT
0x7D PAGE_UP    0x72 ARROW_DOWN     0x4A NUMPAD_/
0x71 DELETE     0x6B ARROW_LEFT     0x5A NUMPAD_ENTER
0x69 END
0x7A PAGE_DOWN

======[ AUTOSHIFT INCLUDED (SPECIAL L_SHIFT SPECIAL DATA /// SPECIAL BREAK DATA SPECIAL BREAK L_SHIFT) (0xE0 0x12 0xE0 DATA /// 0xE0 0xF0 DATA 0xE0 0xF0 0x12) ]======  
0x70 NUMLOCK_INSERT   0x75 NUMLOCK_ARROW_UP     0x7C PRINTSCREEN
0x6C NUMLOCK_HOME     0x74 NUMLOCK_ARROW_RIGHT
0x7D NUMLOCK_PAGEUP   0x72 NUMLOCK_ARROW_DOWN
0x71 NUMLOCK_DELETE   0x6B NUMLOCK_ARROW_LEFT
0x69 NUMLOCK_END
0x7A NUMLOCK_PAGEDOWN

0xE1, 0x14, 0x77, 0xE1, 0xF0, 0x14, 0xF0, 0x77 PAUSEBREAK


uint8_t scanCodeList[] = {
...
#define DATA_F8 0x0A
#define DATA_F9 0x01
#define DATA_F10 0x09
#define DATA_F11 0x78
#define DATA_F12 0x07
#define DATA_NUMPAD_0 0x70
#define DATA_NUMPAD_1 0x69
#define DATA_NUMPAD_2 0x72
#define DATA_NUMPAD_3 0x7A
#define DATA_NUMPAD_4 0x6B
#define DATA_NUMPAD_5 0x73
#define DATA_NUMPAD_6 0x74
#define DATA_NUMPAD_7 0x6C
#define DATA_NUMPAD_8 0x75
#define DATA_NUMPAD_9 0x7D
#define DATA_0 0x45
#define DATA_1 0x16
#define DATA_2 0x1E
#define DATA_3 0x26
...
#define DATA_K 0x4B
#define DATA_L 0x4C
#define DATA_O_DOTS 0x52 // Ö
#define DATA_A_DOTS 0x5D // Ä
#define DATA_Z 0x22
#define DATA_X 0x21
#define DATA_C 0x2A
#define DATA_V 0x32
...
#define DATA_M 0x41
#define DATA_+ 0x4E
#define DATA_ACUTE 0x55 // ´
#define DATA_DOTS 0x1C // ¨
#define DATA_APOSTROPHE 0x61 // '
#define DATA_< 0x1A
#define DATA_, 0x49
#define DATA_. 0x4A
#define DATA_- 0x29
#define DATA_NUMPAD_* 0x7C
#define DATA_NUMPAD_- 0x7B
#define DATA_NUMPAD_+ 0x79
#define DATA_TAB 0x0D
#define DATA_CAPS_LOCK 0x58
#define DATA_L_SHIFT 0x12
#define DATA_L_CTRL 0x14
#define DATA_L_ALT 0x11
#define DATA_BACKSPACE 0x66
#define DATA_ENTER 0x5A
#define DATA_R_SHIFT 0x59
#define DATA_SCROLL_LOCK 0x7E
#define DATA_NUM_LOCK 0x77

// LONG SET (SPECIAL DATA /// SPECIAL BREAK DATA) (0xE0 DATA /// 0xE0 0xF0 DATA)
#define DATA_INSERT 0x70
#define DATA_HOME 0x6C
#define DATA_PAGE_UP 0x7D
#define DATA_DELETE 0x71
#define DATA_END 0x69
#define DATA_PAGE_DOWN 0x7A
#define DATA_ARROW_UP 0x75
#define DATA_ARROW_RIGHT 0x74
#define DATA_ARROW_DOWN 0x72
#define DATA_ARROW_LEFT 0x6B
#define DATA_ALT_GR 0x11
#define DATA_CTRL_ACT 0x14
#define DATA_NUMPAD_/ 0x4A
#define DATA_NUMPAD_ENTER 0x5A

// AUTOSHIFT INCLUDED (SPECIAL L_SHIFT SPECIAL DATA /// SPECIAL BREAK DATA SPECIAL BREAK L_SHIFT) (0xE0 0x12 0xE0 DATA /// 0xE0 0xF0 DATA 0xE0 0xF0 0x12)
#define DATA_NUMLOCK_INSERT 0x70
#define DATA_NUMLOCK_HOME 0x6C
#define DATA_NUMLOCK_PAGEUP 0x7D
#define DATA_NUMLOCK_DELETE 0x71
#define DATA_NUMLOCK_END 0x69
#define DATA_NUMLOCK_PAGEDOWN 0x7A
#define DATA_NUMLOCK_ARROW_UP 0x75
#define DATA_NUMLOCK_ARROW_RIGHT 0x74
#define DATA_NUMLOCK_ARROW_DOWN 0x72
#define DATA_NUMLOCK_ARROW_LEFT 0x6B
#define DATA_PRINTSCREEN 0x7C
